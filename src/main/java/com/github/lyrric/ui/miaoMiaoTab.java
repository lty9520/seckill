...
/**
 * @ClassName miaoMiaoTab
 * @Description
 * @Author lhy
 * @Date 2021-10-31 14:30
 * @Version 1.0
 */
public class miaoMiaoTab extends JPanel {
    ...
    private void init(){
        ...
        setCookieBtn.addActionListener((e)->{
            ConfigDialog dialog = new ConfigDialog((Frame) this.getRootPane().getParent());
        ...
        setMemberBtn.addActionListener((e)->{
            MemberDialog dialog = new MemberDialog((Frame) this.getRootPane().getParent());
            dialog.setModal(true);
            dialog.setModalityType(Dialog.ModalityType.APPLICATION_MODAL);
            dialog.setVisible(true);
            if(dialog.success()){
